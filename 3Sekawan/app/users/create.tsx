...
import { createUserProfile, getUsersWithoutProfiles } from "@/services/database";
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      await createUserProfile({
        ...
        role: canManageUsers ? role : "cashier",
      });
      await loadUsers();
                ...
                {canManageUsers ? (
                  <>
                    ...
                    <ThemedText style={[styles.roleHint, { color: colors.icon }]}>
                      Admin: Full access | Manager: View/edit transactions & products | Cashier:
                      Sales only
                    </ThemedText>
                  </>
                ) : (
                    ...
                    <View style={styles.roleSelector}>
                      ...
                      >
                        <Ionicons
                          ...
                          style={styles.roleIcon}
                        />
                        <ThemedText style={[styles.roleOptionText, { color: "#FFFFFF" }]}>
                          Cashier
                        </ThemedText>
                      </View>
                    </View>
                    <ThemedText style={[styles.roleHint, { color: colors.icon }]}>
                      Non-admin enrollment creates profile with Cashier role.
                    </ThemedText>
                  </>
                )}
              </View>
